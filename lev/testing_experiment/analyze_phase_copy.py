...
if __name__ == '__main__':
    ...
    for chi in chis:
        ...
        if all_phases == True:
            fig_name = f'phase_drift_data_all_entries_trial{TRIAL}.png'
            ...
            fig_name = f'phase_drift_data_one_entry_trial{TRIAL}.png'
            phase_entry = rho[1][2]
            phase = np.arctan2(np.real(phase_entry), np.imag(phase_entry))
