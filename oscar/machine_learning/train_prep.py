...
def prepare_data(datapath, file, savename, input_method, task, p=0.8):
    ...
    if task=='witness':
        ...
        def simplify_targ(df):
            ...
            output_df_1 = df.applymap(lambda x: 1 if x == 0 else 0) # for the elem at index 1, i.e. is separable?
