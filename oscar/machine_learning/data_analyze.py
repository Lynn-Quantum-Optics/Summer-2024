...
def get_witness_dist(df_ls, labels, savename=None):
    # get witness values
    ...
    # return where W is negative
    return [[df['W_min'][df['W_min']<0] for df in df_ls],[df['Wp_t1'][(df['W_min']>=0) & df['Wp_t1']<0] for df in df_ls]]
