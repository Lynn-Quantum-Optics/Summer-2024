...
if __name__ == '__main__':
    ...
    # save the output
    df = m.output_data(f'BCHWP_sweep_{DATE}_{TRIAL}.csv')
    m.shutdown()
    
    
    df = Manager.load_data(f'BCHWP_sweep_{DATE}_{TRIAL}.csv')
    ...
    plt.savefig(f'BCHWP_sweep_{DATE}_{TRIAL}.png', dpi=600)
    plt.show()
