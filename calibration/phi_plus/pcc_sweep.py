...
if __name__ == '__main__':
    ...
    SWEEP_PARAMS = [1, 2, 1, 10, 5] # use for checking state purity at the PCC angle of 1 degree (current place for phi_plus)
